...
var author$project$Main$encodedCode = function (code) {
...
var author$project$Main$Token = F3(
	function (type_, value, position) {
		return {position: position, type_: type_, value: value};
	});
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$int = _Json_decodeInt;
var elm$json$Json$Decode$map3 = _Json_map3;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$tokenDecoder = A4(
...
var author$project$Main$listOfTokensDecoder = elm$json$Json$Decode$list(author$project$Main$tokenDecoder);
...
var author$project$Main$postCode = function (code) {
	return A3(
		elm$http$Http$post,
		author$project$Main$api,
		elm$http$Http$jsonBody(
			author$project$Main$encodedCode(code)),
		author$project$Main$listOfTokensDecoder);
};
...
var author$project$Main$sendPostCode = function (code) {
	return A2(
		elm$http$Http$send,
		author$project$Main$PostCode,
		author$project$Main$postCode(code));
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Analyze':
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$sendPostCode(code));
			default:
				var code = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$Main$Analyze = function (a) {
	return {$: 'Analyze', a: a};
};
...
var author$project$Main$tokenRow = function (token) {
	return A2(
		elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(token.type_)
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(token.value)
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						elm$core$String$fromInt(token.position))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$Attributes$id('lexical-analyzer')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('analyzer-input')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								author$project$Main$Analyze(model.code))
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('analyzer-output scroll')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								elm$html$Html$tbody,
								_List_Nil,
								A2(elm$core$List$map, author$project$Main$tokenRow, model.listOfTokens))
							]))
					]))
			]));
};
